...
After one customer arrives, we need to determine when the next customer will arrive.We want to simulate it 
to show the continuos flow of customers arriving over time.If we don't schedule the next arrival,
the simulation would stop receiving new inputs .
